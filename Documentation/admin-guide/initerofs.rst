...
The kernel automatically detects EROFS format in the initramfs by checking the
magic number at offset 1024. No special kernel parameters are required - just
use an EROFS image as your initramfs.
...
retain_initerofs
    When specified, the kernel will not free the initramfs memory region after
