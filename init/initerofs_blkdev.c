 ...
 * from the initramfs memory region, avoiding unnecessary memory copies.
 */
...
/*
 * Handle a bio by copying data directly from the initramfs memory region.
 * This is a simple synchronous implementation - reads are served directly
 * from the memory-mapped initramfs.
 */
